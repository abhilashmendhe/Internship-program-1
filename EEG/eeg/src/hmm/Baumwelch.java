...
public class Baumwelch {
    ...
    public double[][] getMatrix(ArrayList cluster_fp, ArrayList cluster_bp, ArrayList singletestlabel)
    {
...
//        
//        for(int i=0; i<cluster_fp.size(); i++)
//        {
//            ArrayList t = (ArrayList) cluster_fp.get(i);
...
//        }
//        
//        mean_cert_fp = mean_cert_fp / cluster_fp.size(); 
//        
//        double mean_cert_bp = 0;
//        
//        for(int i=0; i<cluster_bp.size(); i++)
//        {
//            ArrayList t = (ArrayList) cluster_bp.get(i);
//            double temp1_2 = Double.parseDouble((String)singletestlabel.get(2));
//            double temp2_2 = Double.parseDouble((String)t.get(2));
//            double ed2 = Math.pow((temp1_2-temp2_2), 2);
//            ed2=Math.sqrt(ed2);
...
//        }
//        
//        mean_cert_bp = mean_cert_bp / cluster_bp.size(); 
//        
