 ...
 * @author abhil
 */
public class DeleteItemSaleMaker {
    
    public boolean deleteItem(String itemcode, String salecode)
    {
        boolean f = false;
        ...
        try {
            ...
            String query = "delete from saleinfo where itemcode='"+itemcode+"' and salecode='"+salecode+"'";
