 ...
 */
package Spiders;
import dbops.InsertIntoSearchTable;
import java.util.*;
import java.net.*;
import java.io.*;
...
public class Spider {
   ...
   * @param url
   */
  public void addURL(URL url) throws InterruptedException, IOException
  {
   ...
   */
  public void processURL(URL url) throws InterruptedException, IOException
  {
    try {
     // log("Processing: " + url );
 ...
 */
  ...
  extends HTMLEditorKit.ParserCallback {
    ...
    protected void handleLink(URL base,String str) throws InterruptedException, IOException
    {
      try {
   ...
   */
  public void log(String entry) throws InterruptedException, IOException   //method to print
  {
