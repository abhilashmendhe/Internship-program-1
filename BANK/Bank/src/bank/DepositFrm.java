...
public class DepositFrm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String depositamt = jTextField2.getText();
        double bal = Double.parseDouble(balance);
        double depoamt = Double.parseDouble(depositamt);
        bal += depoamt;
        balance = Double.toString(bal);
        if(balance.isEmpty())
            JOptionPane.showMessageDialog(null, "Deposit field is empty");
        else if(new BankOpsMaker().bankamt(balance,accno))
